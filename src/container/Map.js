                    ...
                    <div className="u-layout-wide u-layoutCenter u-layout-withGutter u-padding-r-top u-padding-bottom-xxl">
                        <div className="Grid Grid--withGutter">
                            <div className="Grid-cell u-md-size12of12 u-lg-size12of12 u-padding-right-xl u-margin-r-top">
                                <h3 className="u-text-h3">Visualizzazione componente mappa senza dettaglio</h3>
                                <p>Clicca su un marker per vedere la descrizione apparire nel popup.</p>
                            </div>
                            <div className="Grid-cell u-md-size12of12 u-lg-size12of12 u-padding-right-xl u-margin-r-top">
                            ...
                            <div className="Grid-cell u-md-size12of12 u-lg-size12of12 u-padding-right-xl u-margin-r-top">  
                                <h3 className="u-text-h3">Visualizzazione componente mappa con dettaglio</h3>
                                <p>Clicca su un marker per vederne il dettaglio in forma tabellare.</p>
                            </div>
                            <div className="Grid-cell u-md-size12of12 u-lg-size12of12 u-padding-right-xl u-margin-r-top">
                                <CsvDisplayer src={src}
                                    latFieldName='Lat' longFieldName='Lon' noheader={false} dataColumnName="Luogo"
